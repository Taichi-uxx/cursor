...
- 英語: `move someone emotionally`
  - 日本語: （感情的に）動かす、深く感動させる
  - 例文・ポイント: The movie really moved me.
- 英語: `impress`
  - 日本語: 感銘を与える
  - 例文・ポイント: The performance really impressed me.
- 英語: `stir someone’s emotions`
  - 日本語: 感情を揺さぶる
  - 例文・ポイント: That story stirred my emotions.
- 英語: `inspire`
  - 日本語: 心を奮い立たせる
  - 例文・ポイント: His words inspired me.
- 英語: `pull/tug at someone’s heartstrings`
  - 日本語: 心の琴線に触れる（特に感動的）
  - 例文・ポイント: That scene really tugged at my heartstrings.
...
- 英語: `desperately / with all my effort`
  - 日本語: 必死に
  - 例文・ポイント: I tried desperately to finish on time.
- 英語: `push myself / put in the work`
  - 日本語: 努力する
...
- 英語: `save up`
  - 日本語: 節約する
  - 例文・ポイント: I saved up money for food and clothes.
- 英語: `clothes`
  - 日本語: 衣服
  - 例文・ポイント: I saved up money for food and clothes.
- 英語: `I’ve traveled to ~ / I’ve been to ~`
  - 日本語: 旅行した国
  - 例文・ポイント: I’ve been to 20–30 countries.
- 英語: `spark my interest`
  - 日本語: 興味を引かれた場所
  - 例文・ポイント: The Philippines really sparked my interest.
- 英語: `scenery / sight`
  - 日本語: 光景
  - 例文・ポイント: The sight of rich and poor living side by side was shocking.
- 英語: `dense`
  - 日本語: 密集した
  - 例文・ポイント: Athens is a dense city.
- 英語: `the Mediterranean`
  - 日本語: 地中海
...
- 英語: `gap between the rich and the poor`
  - 日本語: 富裕層と貧困層の差
...
- 英語: `think in English`
  - 日本語: 英語で考える
  - 例文・ポイント: I have to think in English instead of Japanese.
- 英語: `push myself / feel awkward / nervous`
  - 日本語: 努力・緊張
  - 例文・ポイント: I was very nervous when speaking Catalan.
- 英語: `part of the journey / part of the process`
  - 日本語: 成長の過程
...
- 英語: `delicious / very good`
  - 日本語: 美味しい
  - 例文・ポイント: Sushi in Japan is delicious.
- 英語: `expensive`
  - 日本語: 高い
...
- 英語: `France`
  - 日本語: フランス
  - 例文・ポイント: People in Paris may be rude if you don’t speak French
- 英語: `the US`
  - 日本語: 米国
  - 例文・ポイント: Large contrast between rich and poor, chaotic areas
- 英語: `Spain`
  - 日本語: スペイン
  - 例文・ポイント: 住む・生活して学習するのに便利
- 英語: `Japan`
  - 日本語: 日本
  - 例文・ポイント: 食文化・安全性・公共支援が話題
- 英語: `the Mediterranean`
  - 日本語: 地中海
  - 例文・ポイント: 食文化の話題で登場
...
- 英語: `figure it out`
  - 日本語: 理解する／解決する
  - 例文: I can’t figure it out.
- 英語: `familiar / well-known`
  - 日本語: よく知っている／よく知られている
  - 例文: I’m familiar with Tokyo. / Paris is well-known.
- 英語: `pull/tug at someone’s heartstrings`
  - 日本語: 心の琴線に触れる
  - 例文: That scene really tugged at my heartstrings.
- 英語: `spark my interest`
  - 日本語: 興味を引く
  - 例文: The Philippines really sparked my interest.
- 英語: `desperately / with all my effort`
  - 日本語: 必死に／全力で
  - 例文: I tried desperately to finish the task.
- 英語: `dense`
  - 日本語: 密集した
  - 例文: Athens is a dense city.
- 英語: `welfare`
  - 日本語: 公的支援
  - 例文: The government spends money on welfare.
- 英語: `clothes`
  - 日本語: 衣服
  - 例文: I saved up money for food and clothes.
...
- I like both, but I prefer islands to cities.
...
- 共感＋一言：
  - Yeah, I get that — especially when traveling far.
...
- 人間関係や性格表現は複数バリエーションを覚える
  - hostile / antagonistic / have it in for someone
- 文化・旅行話のポイント
  - 比較：国や都市の雰囲気
  - 人の性格の違い（quiet / vibrant）
  - 小さなニュアンスを表現する → 「informal」「laid-back」
...
- emperor：天皇
  - → We have an emperor.
- symbolic figure：象徴的存在
  - → He is a symbolic figure.
- political power：政治的権力
  - → He doesn’t have political power.
- democratic country：民主主義国家
...
- be introduced from ~：〜から伝わる
  - → Cakes were introduced from Western countries.
- originally：もともと
  - → They originally came from the West.
...
- shoot / film a video：動画を撮る
  - → We filmed everything in Manila.
- edit a video：動画を編集する
...
- `~以降 / since / from ~ on`
  - 日本語: 〜以降（ある時点からその後ずっと）
  - 例文: From that point on, I changed my perspective.（その時からものの見方が変わった）
- `plan to do`
  - 日本語: 〜する予定
  - 例文: I plan to visit Egypt next year.
- `chaotic`
  - 日本語: 混沌とした、無秩序な
  - 例文: The city center is always chaotic.
- `naive`
  - 日本語: 経験不足で世間知らずな
  - 例文: I'm still naive about AI.
- `till / by`
  - 日本語: 「〜までに」「〜まで」
  - 例文: Core time is from 10am to 7pm, but I can't finish the job till 7pm. → by 7pm の方がより締め切り感あり
- `develop / develop systems / develop logic`
  - 日本語: 開発する／裏側のロジックを作る
  - 例文: Our company develops the logic behind the product.
- `pile up / accumulate`
  - 日本語: 積み上がる
  - 例文: Creative data accumulates over time.
- `hassling someone`
  - 日本語: しつこく絡む、営業などで迷惑をかける
  - 例文: People were hassling us in the market.
- `scammer`
  - 日本語: 詐欺師
...
- The product strength is…
  - → “pile up”より accumulate / build up が自然。
  - Ex: Our product’s strength is that creative data accumulates over time.
- I've heard Cairo is crazy and lots of people like hassling you and a lot of scammers
  - → 文を整理すると自然になる
...
- I plan to visit Egypt next year.
  - （来年エジプトに行く予定です）
- Our company develops the logic behind the product.
  - （プロダクトの裏側のロジックを開発しています）
- Creative data accumulates over time.
  - （クリエイティブの実績データが積み上がる）
- I've heard Cairo can be pretty chaotic, with lots of people trying to hassle you and plenty of scammers around.
  - （カイロはかなり混沌としていて、人がしつこく絡んできたり詐欺師も多いと聞きました）
...
- Hinduism：ヒンドゥー教
- Christianity：キリスト教
- ring a bell：聞き覚えがある／思い出しそう
  - That name rings a bell.（その名前、聞き覚えある）
- don't bother：わざわざ〜しなくていい／気にしないで
  - Don't bother calling me.（わざわざ電話しなくていいよ）
- apparently：どうやら／聞いたところによると
  - Apparently, he's sick today.（どうやら今日は彼は体調が悪いらしい）
- be exposed to ~：〜に触れる／さらされる
  - Kids should be exposed to different cultures.
- integrate：統合する／溶け込む
  - He integrated into the team quickly.
- on the same page：認識が一致している
  - Are we on the same page?（認識合ってる？）
- by comparison：比較すると
  - It's small by comparison.
- get ~ down：〜を習得する／身につける
  - It took me a while to get the pronunciation down.
- introvert：内向的な人
  - I'm an introvert.
...
- It felt fresh even though I’d been there before.
...
- It’s important to hold on to your core values.
  - （価値観を守ることは大事だ）
- You need to stay on your toes in this environment.
  - （この環境では常に気を抜けない）
- There is no end game in this situation.
  - （この状況に最終ゴールはない）
- That kind of behavior is unheard of.
  - （そんな行動は前代未聞だ）
...
- Crowded places stress me out. → 人混みはストレス
- The downside is ~ / The upside is ~ → 欠点・良い点を説明する
- I don’t know what it’s called. → 名前がわからない時
- Everything was open as normal. → 通常通り
- I went to the pier near the sea and got on a ferry. → フェリーの説明の自然な言い方
- It's a mix/blend of ~ → 融合・混合を表す
...
- philosophy（哲学・価値観）
  - His philosophy shapes his decisions.
- insightful perspective（洞察に富んだ視点）
  - She gave an insightful perspective.
- full of momentum（勢いがある）
  - The project is full of momentum.
- vibrant（活気のある）
  - It’s a vibrant city.
- be out of it（ぼーっとしている）
  - I’m a bit out of it today.
- buy time for 〜（〜のために時間を稼ぐ）
  - We need to buy time for them.
- locals（地元の人）
  - I talked to some locals.
- dive into（深く入り込む）
  - I want to dive into the culture.
- bounce around（あちこち移動する）
  - I bounced around different cities.
- get down to 〜（本腰を入れる）
  - Let’s get down to work.
- what drew you to 〜（何が〜に惹きつけたの？）
...
- I don’t feel like doing anything.
  - → 何もする気がしない
- I just lie in bed scrolling and watching Netflix.
  - → ベッドでだらだらしている
- I’ll go out and treat myself to a nice breakfast.
  - → 自分にご褒美の朝ごはんを食べる
- Let’s get down to business.
  - → 本題に入ろう
...
- lead to / result in
- These systems led to strong social pressure.
...
- Japan used to have a system called the Gonin-gumi, where people were responsible as a group, and that still influences the culture today.
- The defining feature of this system was collective responsibility (renzoku-za). If one member of the group broke the law or failed to pay their taxes, the entire group was held accountable and punished.
- The Gonin-gumi served several critical roles for the government: Tax Collection: The group ensured that every member paid their land taxes. If one farmer fell short, the other four had to cover the difference. Crime Prevention: Members were required to report any suspicious activity or crimes within their group. This essentially turned neighbors into amateur police officers. Religious Surveillance: Following the ban on Christianity, the Gonin-gumi was used to ensure that no members were practicing "prohibited religions." Mutual Aid: On a more positive note, the groups did provide a support network. If a house burned down or a family faced a sudden crisis, the other members were expected to help with labor and resources.
- If one person couldn’t meet the quota, the other four had to cover the difference.
- From an anthropological perspective, culture shapes behavior.
- Geography and history have a strong impact on culture.
- I believe that the behavior, characteristics, and values of people in a country are deeply connected to geographical, historical, and political factors.
...
- flow into ~：〜に流れ込む
- Waste flows into the ocean.
- get polluted：汚れる・汚染される
...
- gift / blessing：恩恵・恵み
- put emphasis / importance on ~：〜を重視する
...
- repetitive / mundane tasks：単純・退屈な作業
...
- Since Tokyo is a major city, there’s a lot of waste and many factories nearby, so the ocean tends to get polluted.
- Tokyo’s such a big city, so there’s a lot of trash and factories, and that makes the water pretty dirty.
...
- I low key like it.
- spoiled = 甘やかされた／腐った
- a spoiled kid / spoiled milk
- aggravated = イライラした／悪化した
...
- out cold = 完全に気絶・熟睡
- stick to ~ = 〜を守る・続ける
- give him the edge = 優位を与える
- cinch = 楽勝
- slippery = 滑りやすい／信用しづらい
- fang = 牙
- vicious = 残酷な／悪循環の
...
- Chances are that I never would've gotten this strong.
  ...
  - 意味
    - Chances are that I never would've gotten this strong.
      - → たぶん、こんなに強くなっていなかったと思う
  - 言い換え
    - I probably wouldn't have gotten this strong.
...
- I’m still recuperating from the trip.
...
- ❌ come across a situation
  - ✔ find myself in a situation / be in a situation
- ❌ came into my mind
  - ✔ came to mind
- ❌ I couldn’t go to anywhere
  - ✔ I couldn’t go anywhere
- ❌ think of a memory
  - ✔ remember something / think back to a memory
- ❌ all I have to do is holding back my laughter
  - ✔ All I can do is hold back my laughter
- ❌ commute on home
  - ✔ commute on the subway / by train
- ❌ some my friend
  - ✔ one of my friends
- ❌ my mother say
  - ✔ my mother said
- ❌ how I react
  - ✔ how I would react / how I’d react
...
- I’d try to hold back my laughter
- We’d have to compensate for the lack of laughter
- That made me think of…
- I wouldn’t know how to react
- If it’s someone who knows me, I’d care more
- It was harder for me to hear you
- I like the way you put it
...
- be compatible with ~ → 相性がいい
- with flying colors → 余裕で成功
- if I feel up to it → 余裕があれば
- palpable tension → 伝わる緊張感
- on a winning streak → 連勝中
- blossom into ~ → 〜に成長する
- that is where the problem lies → 問題の核心はそこ
...
- stay vigilant（警戒を続ける）
- plead with someone to ~（〜するよう懇願する）
- plead guilty / not guilty（有罪／無罪を認める・主張する）
- remain impartial（中立を保つ）
- a prudent decision（賢明な判断）
...
- I can focus better there.
- Soy latte is just right for me.
...
- I butchered that pronunciation.
  - （発音めちゃくちゃだった）
- The company got backlash online.
  - （ネットで批判を受けた）
...
- That was a wrong call
- infiltrate a system / organization
...
- get a kick out of → 感情的な楽しさ（ちょっとクセあり）
- a 20-minute walk → 時間＝形容詞として使う構造
- think through → 表面的ではなく"最後まで検討"
...
- blow it → チャンスを壊す
- fill in → 空白を埋める
- fill someone in on ~ → 情報を補う
- lose it → 感情が爆発する
- have no intention of ~ → する気ゼロ
- have every right to ~ → 当然の権利がある
- blend in → 周囲に溶け込む
...
- She is one of the finest doctors in the country.
  - （彼女は国内で最高レベルの医師の一人だ）
- This is the finest coffee I've ever had.
  - （これは今までで最高のコーヒーだ）
...
- ❌ I have a plan to explore the world this year.
  - ✅ I'm planning to travel around the world this year.
- ❌ Before getting 30
  - ✅ Before I turn 30
- ❌ All part of world
  - ✅ All over the world
- ❌ I decided in detail.
  - ✅ I haven't decided on the details yet.
- ❌ Like, a half year ago.
  - ✅ About six months ago.
- ❌ I try to prepare my dinner or lunch on myself.
  - ✅ I usually cook for myself.
- ❌ I prefer more cultural than how nice this food is.
  - ✅ I'm more interested in the local culture than the food itself.
- ❌ I've been to 12 or 30 countries so far.
  - ✅ I've been to around 13 countries so far.
- ❌ Bear claw is only piece of bear we can eat.
  - ✅ Bear claw is one of the few parts people eat.
- ❌ in my growing up
  - ✅ Growing up... / When I was growing up...
- ❌ every continents in the world
  - ✅ every continent in the world
- ❌ My friend was getting sick after eating that.
  - ✅ My friend got sick after eating it.
...
- I'm not really into huge festivals.
  - 大規模なフェスはあまり好きではありません。
- I prefer smaller, more intimate events.
...
- I'm off to meet my girlfriend.
  - 彼女に会いに行くところです。
- I traveled by myself, but I planned everything on my own.
  - 一人旅だったけど、計画は全部自分で立てました。
  - （by myself と on my own の違いがよく分かる例）
...
- `find myself thinking about ~`
  - I found myself thinking about the past.
  - → 気づけば過去のことを考えていた
- `find myself in a situation where ~`
  - I found myself in a situation where I had no choice.
  - → 選択肢がない状況にいると気づいた
...
- I find myself doing the same thing again.
  - → また同じことをしていると気づく
- I find myself using English more often.
  - → 英語を使う機会が増えていると感じる
...
- 例文:
  ...
  - B: Same difference.
- 類義語: close enough / basically the same / tomato, tomahto
...
- I go to the gym to let off steam.
- I might take you up on that.
- Can you fix me up with someone?
- This is no better than the previous one.
...
- ❌ The group were born in the same year.
  - （グループに「生まれた」は不自然）
  - ✅ The group was formed in 1999.
  - （そのグループは1999年に結成された。）
- ❌ They trust them each other.
  - ✅ They trust each other.
- ❌ They get along with them.
  - ✅ They get along with each other.
- ❌ They are also best artists in Japan.
...
- ❌ demand numbers（意味違い）
  - demand = 要求する
  - OK: The manager demanded results.

ニュアンス比較

| 表現 | 自然さ | ニュアンス |
| --- | --- | --- |
| chase numbers | ◎ | 一番自然・口語 |
| obsess over numbers | ◎ | ネガティブ強め |
| focus on numbers | ◎ | ビジネス寄り |
| pursue numbers | △ | 不自然 |
