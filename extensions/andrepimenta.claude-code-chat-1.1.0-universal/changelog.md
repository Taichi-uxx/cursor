...
- Merged PR [#87](https://github.com/andrepimenta/claude-code-chat/issues/87) from horatio-sans-serif/main
...
- Displays multiple edits with numbered labels (Edit [#1](https://github.com/andrepimenta/claude-code-chat/issues/1), Edit [#2](https://github.com/andrepimenta/claude-code-chat/issues/2), etc.)
